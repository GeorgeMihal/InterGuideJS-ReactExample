...
export const guide: (type: number) => Guide = (type: number) => ({
  rootContext: '[id=f-body]',
  finalElement: {
    render: finalCard,
      ...
      points: [
        {
          ...
          selector: "[data-guide-id='name']",
          direction: 'topRight',
        },
        {
          cardRender: (wrapper, control) => card2(wrapper, control),
          selector: "[data-guide-id='age']",
          direction: 'bottomRight',
        },
        {
          cardRender: (wrapper, control) => card3(wrapper, control),
          selector: "[data-guide-id='submit']",
          direction: 'bottomRight',
          requiredElements: type === 3 ? selectors : [selectors[type]],
        },
      ],
    },
  ],
